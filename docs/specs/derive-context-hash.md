...
> Captured 2026-06-30 (spec revision 2.1, dated 2026-05-13). The upstream document is
> authoritative — re-fetch before relying on exact bytes. Tracked for device realignment in
> NAPPS-1422. Note: the host-side three-secret expansion (HTLC hashlock / auth-anchor / WOTS
> seed) lives in the referenced `derive-vault-secrets.md`, which is **not** included here.
...
across distinct `(appName, network, connectedPubkey, context)`
combinations.
...
"method not supported" (see §2.1). This lets a dApp tell
...
Cross-wallet portability of `deriveContextHash` outputs is only
defined for the canonical networks above.
...
structure — the wallet treats context as opaque bytes.
...
`derive-vault-secrets.md` — encodes
...
| Krawczyk 2010 | <https://eprint.iacr.org/2010/264> |
| BIP-32 | <https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki> |
| BIP-39 | <https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki> |
| BIP-43 | <https://github.com/bitcoin/bips/blob/master/bip-0043.mediawiki> |
| derive-vault-secrets.md | (referenced upstream; not captured here) |
